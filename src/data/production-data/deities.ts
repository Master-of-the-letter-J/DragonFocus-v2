...
export const DEITIES: PantheonDefinition[] = [
	...
	deity('hectate', 'Hectate', 'Doubles Spell Luck per level, improves lootbox odds, unlocks Divine spell rarities, and multiplies created spell effects by twice her level.', 'spell-luck', 2, '1', 1.75),
];
