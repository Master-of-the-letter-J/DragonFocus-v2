...
export const PAGE_UNLOCK_NOTICES: readonly PageUnlockNoticeDefinition[] = [
	{ id: 'earth', title: 'The Earth', destination: 'Use the Earth tab to manage the world and its population.', milestone: 0.25, requiresDragon: true },
	{ id: 'scrolls', title: 'The Scrolls', destination: 'Use the Scrolls tab for account, market, logs, and records.', milestone: 1, requiresDragon: true },
	...
	{ id: 'surveys', title: 'Surveys', destination: 'Open it from The Earth to manage check-in and check-out surveys.', milestone: 0.5, requiresDragon: true },
	{ id: 'energy-upgrades', title: 'Energy Upgrades', destination: "Open it from the Dragon's Lair to improve production systems.", milestone: 1, requiresDragon: true },
	{ id: 'amplifier-efficiency', title: 'Amplifier Efficiency', destination: 'Open Energy Upgrades, then choose Amplifier Efficiency.', milestone: 1, requiresDragon: true },
	{ id: 'producer-upgrades-one', title: 'Producer Type I', destination: 'Open Energy Upgrades, then choose Producer Type I.', milestone: 2, requiresDragon: true },
	{ id: 'producer-upgrades-two', title: 'Producer Type II', destination: 'Open Energy Upgrades, then choose Producer Type II.', milestone: 2, requiresDragon: true },
	{ id: 'quantum-evolution', title: 'Quantum & Evolution', destination: 'Open Energy Upgrades after Armageddon, then choose Quantum & Evolution.', milestone: 5, requiresDragon: true },
	{ id: 'boost-upgrades', title: 'Boost Upgrades', destination: 'Open Energy Upgrades, then choose Boost Upgrades.', milestone: 3, requiresDragon: true },
	...
	{ id: 'finished-goals', title: 'Harvest Goals', destination: 'Open it from The Earth to review, undo, or permanently harvest completed work.', milestone: 0.5, requiresDragon: true },
	...
	{ id: 'goal-multipliers', title: 'Goal Multipliers', destination: 'Open Energy Production, then choose Goal Multipliers.', milestone: 3, requiresDragon: true },
