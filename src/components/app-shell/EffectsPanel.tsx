	...
	return (
		<View style={styles.panel}>
			<View style={styles.panelContent}>
				<ScrollView horizontal style={styles.effectsScroll} showsHorizontalScrollIndicator={false} contentContainerStyle={styles.effects}>
					{active.length ?
						active.map(spell => (
...
const styles = StyleSheet.create({
	...
	panelContent: { minHeight: 48, flexDirection: 'row', alignItems: 'center' },
	effectsScroll: { flex: 1 },
