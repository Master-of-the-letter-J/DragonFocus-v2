...
const lessons = [
	...
	{ icon: '◈', title: 'Dark Energy', body: 'Dark Energy comes primarily from harvesting completed goals. Difficulty changes its Harvest multiplier without increasing base XP; it buys upgrades and deeper progression.' },
