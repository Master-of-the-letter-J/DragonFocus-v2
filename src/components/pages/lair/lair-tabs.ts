...
export const LAIR_TABS = [
	...
	{ id: 'upgrades', label: 'Energy Upgrades', unlockMilestone: 1, noticeId: 'energy-upgrades', childNoticeIds: ['amplifier-efficiency', 'producer-upgrades-one', 'producer-upgrades-two', 'quantum-evolution', 'boost-upgrades'] },
...
export const PRODUCTION_TABS = [
	...
	{ id: 'goals', label: 'Goal Multipliers', unlockMilestone: 3, noticeId: 'goal-multipliers' },
] as const;
...
export const UPGRADE_TABS = [
	{ id: 'amplifier', label: 'Amplifier Efficiency', unlockMilestone: 1, noticeId: 'amplifier-efficiency' },
	{ id: 'producer1', label: 'Producer Type I', unlockMilestone: 2, noticeId: 'producer-upgrades-one' },
	{ id: 'producer2', label: 'Producer Type II', unlockMilestone: 2, noticeId: 'producer-upgrades-two' },
	{ id: 'evolution', label: 'Quantum & Evolution', unlockMilestone: 5, noticeId: 'quantum-evolution' },
	{ id: 'boosts', label: 'Boost Upgrades', unlockMilestone: 3, noticeId: 'boost-upgrades' },
] as const;
